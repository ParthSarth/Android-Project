...
public class DeleteTag extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.deletetag);
		
		tagtype = (EditText)findViewById(R.id.dtagtype);
		tagvalue = (EditText)findViewById(R.id.dtagvalue);
